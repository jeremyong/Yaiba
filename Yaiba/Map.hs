...
mapKeysValuesMonotonic :: ((k1,a)->(k1,a)) -> Map k1 a -> Map k1 a
mapKeysValuesMonotonic _ Tip = Tip
mapKeysValuesMonotonic f (Bin sz k x l r) = let (newKey,newValue) = f (k,x)
                                            in Bin sz newKey newValue (mapKeysValuesMonotonic f l) (mapKeysValuesMonotonic f r)
